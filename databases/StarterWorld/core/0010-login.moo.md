...
name: help_message
type: list
value: ["Available commands from the login screen:", "connect <player> <password>", "welcome", "who", "uptime", "version", "quit"]
flags:
  - readable
  - writable
  - chown
...
type: list
value: ["Welcome to miniMOO!", "The server is running %v.", "Use: connect <player> <password>"]
flags:
  - readable
  - writable
  - chown
